        ...
        if (!!modef && !!modef_num) {
            ...
            if (result.INSTANT_RELOAD && result.COMPONENT_CONTAINER_ID) {
                ...
                BX.ajax.get(url, function (data) {
                    var tableWrapper = document.querySelector('.catalog-products-wrapper');
                    var newTableWrapper = self.findSelectorInHtml(data, '.catalog-products-wrapper');
...
document.addEventListener('DOMContentLoaded', function () {
    const resetButton = document.getElementById('clean_filter');
    const filterForm = document.getElementById('smartfilter');
    ...
    if (resetButton && filterForm) {
        resetButton.addEventListener('click', function (e) {
            ...
            const anyInput = filterForm.querySelector('input:not([type="hidden"])');
            smartFilter.keyup(anyInput)
        });
    }
});